...
def get_sudoku_input() -> array:
    ...
    prepared_sudokus: dict = {
        ...
        7: [
            [
                [None, 4, None, None, 1, None, None, 8, None],
                [3, None, None, 4, None, 2, None, None, 6],
                [None, None, None, 6, None, 8, None, None, None],
                [None, 2, 3, None, None, None, 8, 5, None],
                [8, None, None, None, None, None, None, None, 7],
                [None, 5, 7, None, None, None, 3, 4, None],
                [None, None, None, 5, None, 4, None, None, None],
                [9, None, None, 2, None, 1, None, None, 5],
                [None, 8, None, None, 7, None, None, 1, None]
            ]
        ]
    }
