...
class SudokuHandler:
    ...
    @staticmethod
    def add_possible_number(number: int, line_index: int, column_index: int, sudoku_to_work_on: list) -> None:
        sudoku_to_work_on[line_index][column_index][1].append(number)
    ...
    @staticmethod
    def delete_possible_numbers(line_index: int, column_index: int, sudoku: list, numbers_to_remove=None) -> None:
