...
class TestDetermineCoordinatesOfFieldsDefinitelyBlockedByPossibleNumbers:
    def test_2_fields_with_2_numbers(self):
        ...
        coordinates_blocked: list = manager.determine_coordinates_of_fields_definitely_blocked_by_possible_numbers(number=8, quadrant_index=3, sudoku_to_work_on=sudoku_input)
    ...
    def test_3_fields_with_2_numbers(self):
        ...
        fields_blocked: list = manager.determine_coordinates_of_fields_definitely_blocked_by_possible_numbers(number=8, quadrant_index=3, sudoku_to_work_on=sudoku_input)
